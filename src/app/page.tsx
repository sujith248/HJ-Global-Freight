...
import { FaBox, FaHandshake, FaClock, FaGlobe } from 'react-icons/fa';
                ...
                <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between  gap-16 w-full ">
                    ...
                    >
                        ...
                        <p className="text-lg text-neutral-800 leading-relaxed">
                            Proudly Australian-owned, HJ Global Freight
                            leverages over 60 years of combined experience to
                            deliver tailored freight solutions. With proven
                            expertise, we ensure your cargo arrives at the right
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-center gap-4">
                                ...
                                <span>
                                    Tailored freight movements to meet your
                                    needs
                                </span>
                            </li>
                            <li className="flex items-center gap-4">
                                ...
                                <span>
                                    Proven solutions for timely deliveries
                                </span>
                            </li>
                            <li className="flex items-center gap-4">
